...
if (!empty($PostBody)) {
    ...
    <?php
    if (empty($_SESSION["Shib-Handler"])) {
        ?>
        ...
        ?>
                                            ...
                                            $('loginusr').value = i2b2.UI.cfg.loginDefaultUsername;
                                            $('loginpass').value = i2b2.UI.cfg.loginDefaultPassword;
                                            $('loginButton').click();
        <?php
    }
    ?>
