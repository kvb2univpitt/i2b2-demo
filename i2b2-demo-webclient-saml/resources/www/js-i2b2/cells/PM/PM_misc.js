...
i2b2.PM.model.html.loginDialog = '<div id="i2b2_login_modal_dialog" style="display:block;">\n' +
        ...
        '				<span class="button"><input type="button" id="loginButton" value="Local Login" onclick="i2b2.PM.doLogin()" /></span>\n' +
        '				<span class="button"><input type="button" value="SAML Login" onclick="location.href = \'secure/index.php\';" /></span>\n' +
        '			</div>\n' +
        '		</form>\n' +
        '	</div>\n' +
        '</div>\n';
