...
A Docker image of Wildfly 17.0.1 server running i2b2-core-server ([Release 1.8.0](https://github.com/i2b2/i2b2-core-server/releases/tag/v1.8.0.0001)) connecting to PostgreSQL database.
...
```
docker rmi kvb2univpitt/i2b2-core-server-demo-postgresql:v1.8.0.2024.01
```
